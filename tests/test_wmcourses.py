...
class WMCoursesTestCase(unittest.TestCase):
	...
	@classmethod
	def setUpClass(cls):
		cls.test_file = path.join(HERE, './fixtures/wmcourselist2014-08-08.html')
	...
	def test_get_correct_course_fields(self):
		...
		with open(self.test_file) as f:
			...
			self.assertEqual(course_fields, wmcourses._grab_course_fields(soup))
	...
	def test_military_to_standard_time(self):
		self.assertEqual(wmcourses.format_time(u'0000-0030'), u'12:00AM-12:30AM')
		self.assertEqual(wmcourses.format_time(u'2300-0030'), u'11:00PM-12:30AM')
		self.assertEqual(wmcourses.format_time(u'1159-1200'), u'11:59AM-12:00PM')
		self.assertEqual(wmcourses.format_time(u'0100-0130'), u'01:00AM-01:30AM')
